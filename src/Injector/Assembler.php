...
class Assembler
{
	...
	/**
	 * Wrap a function and resolve all of its dependencies.
	...
	/**
	 * Build an instance of the given type and inject its dependencies.
	...
	protected function build(string $concrete, array $params = [])
	{
		if(!class_exists($concrete))
			throw InjectorException::doesntExist($concrete);
	...
	/**
	 * Resolve all dependencies from a building or wrapping request.
	...
	/**
	 * Try to resolve a primitive dependency.
	...
	/**
	 * Try to resolve an object dependency.
	 * @param \ReflectionParameter $param Parameter to resolve.
